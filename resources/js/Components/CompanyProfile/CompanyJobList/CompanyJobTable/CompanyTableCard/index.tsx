...
export interface CompanyTableCard {
  position: string;
  deadline: string;
  applications: number;
  matched: number;
...
const CompanyTableCard: React.FC<CompanyTableCard> = ({
  position,
  deadline,
  applications,
  matched,
    ...
    <tr>
      <td data-label="Job Title">
        <div className="job-content">
          <h5><a href="job-details-for-company.html">{position}</a></h5>
          <p><img src={CalendarIcon} alt="" /><span>Deadline:</span>{deadline}</p>
      ...
      <td data-label="Applications">
        <span className="total-number">{applications}</span>
      </td>
      <td data-label="Matched">
        <span className="total-number light-orange">{matched}</span>
      </td>
      <td data-label="Shortlisted">
        <span className="total-number">{shortListed}</span>
      </td>
      <td data-label="Viewed">
        <span className="total-number light-yellow">{viewed}</span>
      </td>
      <td data-label="Not Viewed">
        <span className="total-number deep-pink">{notViewed}</span>
      </td>
      <td data-label="Action">
        <ul className="action-btn-group2">
          <li>
            <a href="#" className="primry-btn-2  eg-btn green--btn">
          ...
          <li>
            <a href="#" className="primry-btn-2 eg-btn sky--btn">
