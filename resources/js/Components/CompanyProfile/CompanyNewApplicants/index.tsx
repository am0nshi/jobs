            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  ...
                  <div className="employee-content">
                    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Mr. Willium Jacson</button>
                    {/* Modal */}
                        ...
                        <div className="modal-content">
                          <div className="modal-header">
                            <div className="button-groups">
                              <ul>
                                <li>
                                  <button className="primary-bg"><img src="assets/images/icon/pdf2.svg" alt="" /> Download PDF</button>
                                  <button><img src="assets/images/icon/shortlist2.svg" alt="" /> Shortlist</button>
                                  <button className="red-bg"><img src="assets/images/icon/reject2.svg" alt="" /> reject</button>
                                </li>
                              </ul>
                            </div>
                    ...
                    <span><img src="assets/images/icon/company-2.svg" alt="" />Internation Colliegate University</span>
              ...
              <td data-label="Actions">
                <div className="action-btn-group">
                  <ul>
                    <li><button><img src="assets/images/icon/shortlist-icon.svg" alt="" /> Shortlist</button></li>
                    <li><button className="reject"><img src="assets/images/icon/rejected-icon.svg" alt="" /> Rejected</button></li>
                  </ul>
                </div>
              </td>
            </tr>
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  ...
                  <div className="employee-content">
                    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1">Robert Williamson </button>
                    {/*  Modal  */}
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  ...
                  <div className="employee-content">
                    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">Robertson Harry</button>
                    {/* Modal  */}
                    ...
                    <span><img src="assets/images/icon/company-2.svg" alt="" />Royals Republic University</span>
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  ...
                  <div className="employee-content">
                    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal3">Hari Jonson</button>
                    {/* Modal  */}
                    ...
                    <span><img src="assets/images/icon/company-2.svg" alt="" />Bistro Mycol University</span>
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  ...
                  <div className="employee-content">
                    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal4">Mrs. Jordan Harry</button>
                    {/* Modal */}
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  ...
                  <div className="employee-content">
                    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal5">Juliya Bhut</button>
                    {/* Modal */}
                    <div className="modal fade" id="exampleModal5" tabIndex={-1} aria-hidden="true">
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <div className="button-groups">
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  ...
                  <div className="employee-content">
                    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal6">Mr. Willium Jacson</button>
                    {/* Modal */}
                    <div className="modal fade" id="exampleModal6" tabIndex={-1} aria-hidden="true">
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <div className="button-groups">
