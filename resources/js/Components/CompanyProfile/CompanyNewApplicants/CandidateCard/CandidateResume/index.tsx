import ResumeAuthorIcon from "/public/assets/images/bg/resume-author.png"
import PhoneIcon from "/public/assets/images/icon/phone-5.svg"
import EnvLopIcon from "/public/assets/images/icon/envlop-5.svg"
import Web5Icon from "/public/assets/images/icon/web-5.svg"
              ...
              <div className="row g-4 mb-40">
                ...
                <div className="col-lg-6">
                  <div className="contact-area">
                    <h4>Contact Info</h4>
                    <ul>
                      <li>Phone:<a href="#">+880-177 443 5455 <span><img src={PhoneIcon} alt="" /></span></a></li>
                      <li>Email:<a href="#">info@example.com <span><img src={EnvLopIcon} alt="" /></span></a></li>
                      <li>Website:<a href="#">www.infositeexample.com <span><img src={Web5Icon} alt="" /></span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
